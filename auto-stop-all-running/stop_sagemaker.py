...
def stop_jobs(instance_type,RunningInstances) : 
    ...
    # commented out because of this "errorMessage": "'SageMaker' object has no attribute 'list_compilation_jobs'",
    ...
    # commented out because of this "errorMessage": "'SageMaker' object has no attribute 'list_labeling_jobs'",
    # for job in jobs:
